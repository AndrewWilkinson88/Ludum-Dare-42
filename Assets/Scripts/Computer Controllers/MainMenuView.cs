...
namespace DeleteAfterReading
{
    public class MainMenuView : MonoBehaviour
    {
        ...
        public AudioSource logoSond;
        public AudioSource showMissionsSound;
        ...
        public void StartTitleScreenSequence()
        {
            ...
            startSequence.AppendCallback(() => logoSond.Play());
            ...
            startSequence.AppendCallback(() => ComputerController.instance.stickyNoteSound.Play());
            startSequence.Append(stickyArm.transform.DOLocalMoveY(-13, 0.5f).SetEase(Ease.InExpo));
            startSequence.AppendCallback(() => { mission1.transform.parent.gameObject.SetActive(true); showMissionsSound.Play(); });
            startSequence.Play();
        }
